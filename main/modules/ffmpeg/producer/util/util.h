...
core::mutable_frame make_frame_afd(const void* tag, const spl::shared_ptr<AVFrame>& decoded_frame, core::frame_factory& frame_factory, const core::audio_channel_layout& channel_layout, int source_afd_code, const core::video_format_desc format_desc_, core::video_channel* pChannel);
