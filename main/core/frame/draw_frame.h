...
namespace caspar { namespace core {
	struct AFD_COMMAND
	{
		AFD_COMMAND() :afd_aspect_ratio_(-1), afd_command_(-1) {}
		int afd_aspect_ratio_;
		int afd_command_;
	};
...
public: 
	AFD_COMMAND out_afd_command;//afd command
	int source_afd_code;// afd code from *.mxf or sdi.
};
