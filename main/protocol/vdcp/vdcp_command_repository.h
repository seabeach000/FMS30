...
class vdcp_command_repository : boost::noncopyable
{
public:
	vdcp_command_repository(
	...
	VDCPCommand::ptr_type create_command(const std::wstring& s, IO::ClientInfoPtr client, std::list<std::wstring>& tokens) const;
	VDCPCommand::ptr_type create_channel_command(
			const std::wstring& s,
	...
	void register_command(std::wstring category, std::wstring name, core::help_item_describer describer, vdcp_command_func command, int min_num_params);
	void register_channel_command(std::wstring category, std::wstring name, core::help_item_describer describer, vdcp_command_func command, int min_num_params);
private:
	struct impl;
